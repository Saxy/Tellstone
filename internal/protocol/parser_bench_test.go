...
func BenchmarkParseSQL_Select_Sequential(b *testing.B) {
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		q, err := ParseQuery(pgSelectQuery)
		if err != nil {
			b.Fatal(err)
		}
		if q.Type != CmdGet {
...
func BenchmarkParseSQL_Insert_Sequential(b *testing.B) {
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		q, err := ParseQuery(pgInsertQuery)
		if err != nil {
			b.Fatal(err)
		}
		if q.Type != CmdSet {
...
func BenchmarkParseSQL_Select_Whitespace_Sequential(b *testing.B) {
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		q, err := ParseQuery(pgSelectWhitespace)
		if err != nil {
			b.Fatal(err)
		}
		if q.Type != CmdGet {
...
func BenchmarkParseSQL_Select_MixedCase_Sequential(b *testing.B) {
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		q, err := ParseQuery(pgSelectMixedCase)
		if err != nil {
			b.Fatal(err)
		}
		if q.Type != CmdGet {
...
func BenchmarkParseSQL_Insert_LongValue_Sequential(b *testing.B) {
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		q, err := ParseQuery(pgInsertLongValue)
		if err != nil {
			b.Fatal(err)
		}
		if q.Type != CmdSet {
...
func BenchmarkParseSQL_Insert_TTLOverflow_Sequential(b *testing.B) {
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		_, err := ParseQuery(pgInsertTTLOverflow)
		if err == nil {
...
func BenchmarkParseSQL_Select_UTF8Key_Sequential(b *testing.B) {
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		q, err := ParseQuery(pgSelectUTF8Key)
		if err != nil {
			b.Fatal(err)
		}
		if q.Type != CmdGet {
